...
python3 train.py --config=yolact_plus_resnet101_person_config --resume=weights/yolact_plus_base_54_800000.pth --only_last_layer --start_iter=0 --batch_size=8 --lr=1e-5 --momentum=0.9 --decay=5e-4 --gamma=0.1
